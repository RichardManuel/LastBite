...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('restaurants', function (Blueprint $table) {
            ...
            $table->integer('ratings_count')->default(0); // Digabung dari migrasi ratings_count
            $table->decimal('avg_rating', 3, 1)->default(0.0); // Digabung dari migrasi avg_rating // Rating dari 0.0 s.d. 5.0
