    ...
    <main class="main-content mb-5">
        @if (isset($restaurant))
            <div class="profile-banner"
                style="background-image: url('{{ asset('storage/' . $restaurant->restaurant_picture_path) }}');"></div>
                ...
                <div class="profile-details-card">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div class="rating-badge-custom">
                            <div class="rating-score">{{ $restaurant->avg_rating }}★</div>
                            <div class="rating-count">{{ $restaurant->ratings_count }} ratings</div>
                        </div>
                    </div>
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <span
                                class="info-value">#{{ $restaurant->application_id_display ?? ($restaurant->restaurant_id ?? 'N/A') }}</span>
                        </div>
                        <div class="info-item">
