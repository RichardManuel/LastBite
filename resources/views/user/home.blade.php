...
@section('content')
    ...
    <!-- Hero Section -->
    <section class="hero-home" style="background-image: url('{{ asset('img/hero-bg.svg') }}');">
        <div class="content">
        ...
        <div class="container">
            ...
            <div class="steps-wrapper">
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('img/step1.png') }}" alt="Browse Eatery Page" class="step-image">
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-5 flex-row-reverse">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('img/step2.png') }}" alt="Eatery Detail Page" class="step-image">
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('img/step3.png') }}" alt="Browse Eatery Page" class="step-image">
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-5 flex-row-reverse">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('img/step4.png') }}" alt="Eatery Detail Page" class="step-image">
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('img/step5.png') }}" alt="Browse Eatery Page" class="step-image">
                    </div>
                </div>
            </div>
        ...
        <div class="row g-0 align-items-center"> {{-- g-0 untuk menghapus gutter/spasi antar kolom --}}
            ...
            <div class="col-lg-6">
                <div class="introducing-image-wrapper"> {{-- Pembungkus baru untuk positioning --}}
                    <img src="{{ asset('img/introduceback.png') }}" alt="A delicious pastry" class="img-fluid introducing-image-bg">

                    {{-- Logo yang menimpa (akan kita atur di CSS) --}}
                    <img src="{{ asset('img/LogoLastBite.png') }}" alt="LastBite Logo" class="introducing-logo-overlay">
                </div>
            </div>
