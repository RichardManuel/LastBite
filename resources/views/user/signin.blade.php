...
<head>
    ...
    <style>
        :root {
            --brand-green: #3A6B50;
            --brand-green-light-texture: #E0EFEA;
            /* Perkiraan warna untuk background tekstur kiri, sesuaikan! */
            --brand-orange: #F59E0B;
            --input-bg: #F3F4F6;
            --form-column-bg: #FFFFFF;
            /* Warna background kolom kanan */
            --text-dark: #374151;
            --text-light: #6B7280;
        ...
        body {
            ...
            overflow-x: hidden;
            /* Mencegah scroll horizontal jika ada sedikit overflow */
        }

        .register-full-page-layout {
            display: flex;
            min-height: 100vh;
            /* Memastikan layout mengisi tinggi viewport */
            width: 100%;
        }
        ...
        .register-image-column {
            ...
            align-items: center;
            position: relative;
            /* Berguna jika Anda ingin memposisikan sesuatu absolut di dalamnya */
        }
        ...
        .register-image-column img.illustration {
            ...
            max-height: 100%;
            /* Pastikan gambar tidak melebihi tinggi kolom */
            /* object-fit: contain; */
        }

        .register-form-column {
            flex: 1 1 auto;
            /* Mengambil sisa ruang dan bisa tumbuh/menyusut */
            background-color: var(--form-column-bg);
            display: flex;
            justify-content: center;
            align-items: center;
            padding: 3rem 2rem;
            /* Padding di dalam kolom form */
            overflow-y: auto;
            /* Scroll jika konten form sangat panjang */
        }

        .register-form-wrapper {
            width: 100%;
            max-width: 430px;
            /* Lebar maksimal untuk konten form */
        }
        ...
        .form-control {
            ...
            /* Sedikit lebih kecil roundednya */
            padding: 0.7rem 1rem;
            /* Sedikit disesuaikan */
            font-size: 0.9rem;
            font-family: 'Instrument Sans', sans-serif;
        ...
        @media (max-width: 991px) {
            ...
            .register-image-column {
                flex: 0 0 auto;
                /* Lebar tidak lagi 50%, biarkan konten menentukan */
                min-height: 35vh;
                /* Tinggi minimum untuk kolom gambar di tablet */
                /* display: none; */
                /* Opsi: sembunyikan jika mau */
            }
        ...
        @media (max-width: 576px) {
            ...
            .register-image-column {
                display: none;
                /* Sembunyikan gambar di mobile agar fokus ke form */
            }
            ...
            .register-form-column {
                ...
                min-height: 100vh;
                /* Pastikan form mengisi layar jika gambar hilang */
            }
...
<body>
    ...
    <div class="register-full-page-layout">
        <div class="register-image-column">
            <img src="{{ asset('img/Rectangle 32.png') }}" alt="Create Account Illustration" class="illustration">
        </div>
        <div class="register-form-column text-center">
