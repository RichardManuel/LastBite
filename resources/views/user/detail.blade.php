    ...
    <div class="container-fluid mb-5 px-0">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-5 text-center text-md-start">
                            <img src="{{ asset(path: 'img/Surpised-Bag.svg') }}" alt="Surprise Bag" class="img-fluid">
                        </div>
                        <div class="col-md-7">
                            <h3 class="fw-bold display-1">Surprise Bag</h3>
                            <p class="price">Rp {{ number_format($eatery->pricing_tier, 0, ',', '.') }}</p>
        ...
        <div id="panel-pickup-time" class="dynamic-panel">
            <div class="dynamic-panel-container panel-pick-up-time">
                <div class="row align-items-center">
                    <div class="col-md-5 text-center text-md-start">
                        <img src="{{ asset('img/Pick up time.svg') }}" alt="Illustration" class="img-fluid">
                    </div>
                    <div class="col-md-7">
                        ...
                        <div class="note mt-3">
                            <p class="mb-0"><strong class="text-warning">⚠ Please Note:</strong></p>
                            <p class="mb-0">Orders must be picked up on time. Missed orders will be canceled automatically
                                with no refund.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2 align-items-start">
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="map-placeholder">
                            <iframe
                                src="https://maps.google.com/maps?q={{ urlencode($eatery->location) }}&t=&z=15&ie=UTF8&iwloc=&output=embed"
